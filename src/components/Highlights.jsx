...
const Highlights = () => {
  ...
  const highlights = [
    {
      title: "Engineering",
      description:
        "Where innovation meets impact through technology, design, and real-world problem-solving.",
      bgColor: "bg-[#4D84F7]",
    ...
    },
    {
      title: "Medical",
      description:
        "Showcasing breakthroughs that blend compassion with cutting-edge healthcare innovation.",
      bgColor: "bg-[#E371E3]",
      svg: "/medical-bg.svg",
    },
    {
      title: "Arts & Science",
      description:
        "Celebrating creativity, research, and interdisciplinary thinking that shape tomorrow's ideas.",
      bgColor: "bg-[#4D84F7]",
    ...
    },
    {
      title: "Management",
      description:
        "Empowering future leaders to drive change, innovation, and entrepreneurial growth.",
      bgColor: "bg-[#3E80BF]",
  ...
  const HighlightCard = ({ item, position }) => {
    return (
      <div
        className={`${item.bgColor} p-4 md:p-6 lg:p-8 w-full aspect-square flex flex-col justify-start items-start relative overflow-hidden`}
      >
        {/* Background SVG */}
      ...
      <div className="px-5 md:px-8 lg:px-12 pt-8 md:pt-12 pb-8 md:pb-16 flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 md:gap-8 lg:gap-12 md:mb-40">
        ...
        <div className="flex-1 w-full lg:w-auto">
          ...
          <p className="text-xs md:text-lg lg:text-2xl text-black font-normal font-gilroy-light max-w-md leading-relaxed">
            Experience Kerala's largest student entrepreneurship platform with
            world-class speakers, hands-on workshops, and unparalleled
        ...
        {/* Right Cards Grid */}
        <div
          className="grid grid-cols-2 gap-3 md:gap-3 lg:gap-4 w-full lg:w-150 lg:shrink-0"
