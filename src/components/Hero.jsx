...
const Hero = () => {
  ...
  return (
    <div
      id="home"
      className="w-full h-[110vh] md:h-[110vh] relative bg-white overflow-hidden"
    >
      {/* Mobile Layout - Hidden on md and up */}
      <div className="md:hidden w-full min-h-screen relative bg-white">
        {/* Decorative Circles for Mobile */}
        <div
          className="w-64 h-64 absolute left-[-29px] top-[500px] opacity-50 rounded-full border-[0.50px] border-blue-600 animate-fade-in-up"
          style={{ animationDelay: "0.6s" }}
        />
        <img
          src="/Ellipse3.svg"
          alt="Decorative"
          className="w-72 h-72 absolute left-[80px] top-[350px] opacity-50 animate-fade-in-up"
        ...
        <div className="px-5 pt-24 pb-20 relative z-10">
          ...
          {/* Location */}
          <div
            className="text-blue-400 text-xl font-semibold font-clash-display mb-2 animate-fade-in-up"
          ...
          {/* Date */}
          <div
            className="flex items-center gap-2 relative mb-4 animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
            <div className="text-blue-500 text-lg font-bold font-gilroy-bold relative z-10">
              22 Dec 2025
            </div>
          ...
          {/* Early Bird */}
          <div
            className="text-blue-400 text-sm font-normal font-gilroy-bold animate-fade-in-up"
        ...
        <div
          className="absolute bottom-0 right-0 w-[65%] max-w-[260px] z-10 animate-slide-in-right"
        ...
        <img
          ...
          className="w-full h-14 object-cover absolute bottom-0 left-0 z-5 animate-fade-in-up"
          style={{ animationDelay: "0.9s" }}
        />

        {/* Countdown Badge - Mobile */}
        <div
          className="absolute bottom-16 left-4 max-w-[320px] animate-fade-in-up"
          style={{ animationDelay: "0.9s" }}
        >
          <div className="bg-white/95 backdrop-blur-sm rounded-lg px-3 py-2.5 shadow-lg border-2 border-blue-200">
            <div className="grid grid-cols-4 gap-1.5">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-blue-400 text-[10px] sm:text-xs font-bold font-gilroy-bold mt-0.5">
                  DAYS
                </div>
              </div>
              {/* Hours */}
      ...
      <div className="hidden md:block w-full min-h-screen lg:h-[110vh] relative">
        ...
        <img
          ...
          className="w-1/2 absolute left-1/2 top-10 opacity-50 animate-fade-in-up"
          style={{ animationDelay: "0.1s" }}
        />
        <img
          src="/Ellipse3.svg"
          alt="Decorative circle 2"
          className="w-2/5 absolute right-10 top-20 lg:top-30 animate-fade-in-up"
          style={{ animationDelay: "0.2s" }}
        />
        <img
          src="/Ellipse3.svg"
          alt="Decorative circle 3"
          className="w-2/5 absolute -right-80 top-20 lg:top-30 opacity-25 animate-fade-in-up"
          style={{ animationDelay: "0.3s" }}
        />
        <img
          src="/Ellipse3.svg"
          alt="Decorative circle 4"
          className="w-1/3 absolute left-130 bottom-20 lg:bottom-30 opacity-5 animate-fade-in-up"
          style={{ animationDelay: "0.4s" }}
        />

        {/* Main Content Container */}
        <div
          className="w-1/2 absolute top-[6vh] md:top-[25vh] lg:top-[13vh] xl:top-[25vh] left-[10%] flex flex-col gap-3 pb-40 animate-fade-in-down"
          style={{ animationDelay: "0.5s" }}
        >
          {/* Title with Logo */}
          <div className="relative">
            ...
            <img
              className="w-[2vh] md:w-[10vh] lg:w-[15vh] h-auto absolute -top-[3vh]  lg:-top-[8vh] left-[8vh] md:left-[12vh] lg:left-[20vh] animate-scale-in"
              style={{ animationDelay: "0.6s" }}
            ...
            {/* Location */}
            <div className="text-[#597fba] text-[2vh] lg:text-[3vh] font-semibold font-gilroy-medium">
              Kasaragod
            </div>
            ...
            <div className="flex items-center relative my-[0.5vh] lg:my-[1vh]">
              <img
                src="/Ellipse1.svg"
                alt="Decorative circle 1"
                className="w-[1.5vh] lg:w-[2vh] h-[1.5vh] lg:h-[2vh] absolute -top-[0.2vh] lg:-top-[0.5vh] left-[3vh] lg:left-[4vh]"
              />
              <div className="text-blue-500 text-[2.5vh] lg:text-[4vh] font-black leading-[2vh]  font-gilroy-bold relative z-10">
                22 Dec 2025
              </div>
            </div>
        ...
        <img
          src="/hero-blocks.png"
          alt="Decorative blocks"
          className="w-full h-16 lg:h-[10vh] absolute bottom-0 lg:bottom-[9vh] left-0 object-cover animate-fade-in-up"
          style={{ animationDelay: "0.7s" }}
        />
        ...
        <img
          src="/hero-img.png"
          alt="Decorative blocks"
          className="h-[50vh] lg:h-[70vh] xl:h-[90vh] absolute bottom-[1vh] lg:bottom-[8%] right-[1%] object-contain animate-slide-in-right"
          style={{ animationDelay: "0.8s" }}
        />
